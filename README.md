...
## Demo alpha # 0.0.2
[![Video](images/screenshot_addon.png)](https://www.youtube.com/watch?v=wy_onMYQn3Q)
...
- **API Key from app.locki.io**: Connect your MultiversX devnet wallet to [app.locki.io](https://app.locki.io/profile) and obtain a connection NativeAuthToken. This key allows the addon to communicate and manage 3D data from your wallet.
...
5. In the addon preferences, enter your NativeAuthToken from app.locki.io.

## Usage

1. **Configuration**: After installing the addon, go to Blender preferences and locate the MultiversX addon settings. Here, enter your wallet address and the associated NativeAuthToken.  

![Enter your Native Auth Token](images/enterapikey.png)
...
3. **Trying CAD Creations**: If you're keen on experimenting with CAD creation features, please send us a request on the [Locki Discord](https://discord.gg/HsmtTCRaB). We'd be thrilled to facilitate a minting process for your designs.
